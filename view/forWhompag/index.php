...
<head>
  ...
  <?php
  $cssTime = filemtime('../../view/forWhompag/style.css'); // ejemplo: '../Home/5.Video/video.css'
  ?>
  <link rel="stylesheet" href="../../view/forWhompag/style.css?v=<?= $cssTime ?>">


  <!-- Título de la página -->
  <title>D'LARCS - Páginas para quienes? </title>
...
<body class="formWhom_body">
 <?php include "../../view/global/menu/menu.php" ?>
 <?php include "../../view/forWhompag/seccion/forWhompag.php" ?>
