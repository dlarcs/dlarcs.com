...
<head>
  ...
  <?php
  $cssTime = filemtime('../../view/portfolio/style.css'); // ejemplo: '../Home/5.Video/video.css'
  ?>
  <link rel="stylesheet" href="../../view/portfolio/style.css?v=<?= $cssTime ?>">
...
<body class="portfolio_body">
 ...
 <?php include "../../view/portfolio/seccion/portfolio.php" ?>
