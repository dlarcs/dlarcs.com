...
<head>
  ...
  <?php
  $cssTime = filemtime('../../view/servicios/style.css'); // ejemplo: '../Home/5.Video/video.css'
  ?>
  <link rel="stylesheet" href="../../view/animaciones/style.css?v=<?= $cssTime ?>">


  <!-- Título de la página -->
  <title>D'LARCS - Planes y servicios </title>
...
<?php include "../../view/global/menu/menu.php" ?>
 <?php include "../../view/animaciones/seccion/animaciones.php" ?>
 <?php include "../../view/animaciones/seccion1/box.php" ?>
 <?php include "../../view/animaciones/seccion2/seccion2.php" ?>
 <?php include "../../view/animaciones/seccion3/seccion3.php" ?>
